      ...
      geo: {
        ...
        itemStyle: {
          normal: {
            ...
            borderWidth: 1,
            areaColor: {
              ...DEFAULT_THEME_RADIAL_COLOR_LIST[0],
              start: DEFAULT_THEME_RADIAL_COLOR_LIST[0].end,
              end: DEFAULT_THEME_RADIAL_COLOR_LIST[0].start,
              type: 'radial',
              radialPosition: {
                x: 0.5,
                y: 0.5,
          ...
          emphasis: {
            borderColor: ThemeUtil.generateNextColor4CurrentTheme(0),
            borderWidth: 1,
            areaColor: DEFAULT_THEME_RADIAL_COLOR_LIST[0],
            shadowColor: ThemeUtil.generateNextColor4CurrentTheme(0),
            shadowOffsetX: -2,
            shadowOffsetY: 2,
            shadowBlur: 10,
